...
const Information = () => {
    ...
    return (
        <div className="Information my-16">
            <h1 className="text-2xl mx-48 text-center underline underline-offset-8">Información Práctica</h1>
            <div className="grid grid-rows-2 grid-flow-col gap-16 mt-10">
                <div className="mx-6 hover:border-solid rounded-2">
                    <h1 className="text-7xl">
                        <CgGym className="ml-40" />
                    </h1>
                    <h2 className="mt-3">Salas muy amplias con maquinas de última generación</h2>
                </div>
                <div className="mx-28 hover:border-solid rounded-2">
                    <h1 className="text-7xl">
                        <MdSportsGymnastics className="ml-16" />
                    </h1>
                    <h2 className="mt-3">Un montón de actividades</h2>
                </div>
                <div className="mx-20 hover:border-solid rounded-2">
                    <h1 className="text-7xl">
